    ...
    <div class="col-md-7">
        <form action="/dashboard/post" method="post" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="form-input my-3">
                ...
                <input type="text" class="input form-control" name="slug" id="slug" placeholder="Slug" readonly value="{{ old('slug') }}">
            </div>
            <div class="form-input my-3">
            ...
            <div class="form-input my-3">
                ...
                @enderror
                <input type="hidden" id="x" name="body" value="{{ old('body') }}">
                <trix-editor input="x"></trix-editor>
            </div>
            <div class="form-input my-3">
                <button type="submit" class="btn btn-primary py-2 mt-3">Create</button>
            </div>
        </form>
    </div>
